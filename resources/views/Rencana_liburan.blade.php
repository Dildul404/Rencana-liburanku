<x-Layout>
    ...
    <div class="flex flex-col-reverse lg:flex-row w-full justify-center gap-2">
        <section class=" w-full border-x-1 border-gray-700">
            ...
            @guest
            {{-- Form location --}}
                <div id="location_form" class="hidden w-full p-5 select-none pointer-events-none opacity-80">
            ...
            @auth
                    ...
                    @foreach (Auth::user()->destinations[0]->locations as $item)
                        ...
                        <div class="px-5 my-2 w-full">
                            <table class="w-full border-1 border-gray-700 rounded-md shadow-md">
                                <tr>
                                    <td class="p-2 border-r-1 border-gray-700 flex justify-center">
                                    ...
                                    <td class="p-2 border-r-1 border-gray-700 w-3/4">
                                        {{ $item['location'] ?? '-' }}
                                    </td>
                        ...
                        <form action="/activities" method="POST" class="hidden border-1 border-gray-700 rounded-md p-2" id="form_activity">
                            <table class="w-full">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input type="text" value="{{ $judul }}" hidden>
