...
<body class="h-full">
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Buat akun</h2>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
                <label for="email" class="block text-sm/6 font-medium text-gray-100">Nama pengguna</label>
                <div class="mt-2">
            ...
            <div>
                <label for="email" class="block text-sm/6 font-medium text-gray-100">Alamat email</label>
                <div class="mt-2">
                <input id="email" type="email" name="email" required autocomplete="email" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                </div>
            </div>
            ...
            <div>
                ...
                <label for="password" class="block text-sm/6 font-medium text-gray-100">Kata sandi</label>
                </div>
                <div class="mt-2">
            ...
            Sudah memiliki akun?
            <a href="/login" class="font-semibold text-indigo-400 hover:text-indigo-300">Masuk sekarang!</a>
            </p>
        </div>
    </div>
